document.addEventListener('DOMContentLoaded', function () {
  ...
  let rawText = "Agencia de desarrollo web especializada\nen diseño web profesional y estratégico.";
  if (anchoPantalla <= 768) {
    rawText = "Agencia de desarrollo web especializada en diseño web profesional y estratégico";
  }
